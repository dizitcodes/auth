            ...
            <div class="col-md-8 col-sm-10 col-lg-6 col-xl-5">
                ...
                <div class="card card-body border-0 shadow-lg py-5 px-4">
                    <div class="text-center">
                        ...
                        <div>
                            <h2 class="mb-3">Conectado com sucesso!</h2>
                            <p class="mb-5 text-body-secondary">
                                Você será redirecionado em aproximadamente 3 segundos.
                            </p>
                            <a href="<?= base_url('admin/dashboard') ?>" class="btn btn-primary">Entrar agora <span class="material-symbols-rounded align-middle me-2">arrow_forward</span></a>
                        </div>
                    </div>
                </div>
            </div>
